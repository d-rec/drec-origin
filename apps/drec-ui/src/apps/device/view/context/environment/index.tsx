...
export const DeviceAppEnvProvider: FC<DeviceAppEnvProviderProps> = ({ variables, children }) => {
    return <DeviceAppEnv.Provider value={variables}>{children}</DeviceAppEnv.Provider>;
};
