...
type TPublicDeviceCardContent = <Id>(props: PublicDeviceCardContentProps<Id>) => ReactElement;

export const PublicDeviceCardContent: TPublicDeviceCardContent = ({ id, specsData, iconsData }) => {
