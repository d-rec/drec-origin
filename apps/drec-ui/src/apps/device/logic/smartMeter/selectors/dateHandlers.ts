...
import { ReadingsWindowEnum, getTimeUnitOnWindow } from 'utils';
...
export const useDateArrowHandlers = ({
    ...
    return {
        incrementDate: createIncrementFunc(window, startDate, endDate, setStartDate, setEndDate),
        decrementDate: createDecrementFunc(window, startDate, endDate, setStartDate, setEndDate)
    };
};
