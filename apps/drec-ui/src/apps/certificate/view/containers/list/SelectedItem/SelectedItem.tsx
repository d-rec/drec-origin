...
export type TSelectedItem = <Id>(props: PropsWithChildren<SelectedItemProps<Id>>) => ReactElement;
            ...
            <div className={classes.wrapper}>
                ...
                <div className={classes.item}>
                    ...
                    {!editMode ? (
                        ...
                        <Button className={classes.item} onClick={closeEditMode} color="inherit">
                            {cancelText}
                        </Button>
                    )}
                </div>
