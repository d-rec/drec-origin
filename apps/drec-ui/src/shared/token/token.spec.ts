...
describe('Authentication Token', () => {
    ...
    it('should set token to local storage', () => {
        ...
        expect(localStorage.setItem).toHaveBeenLastCalledWith(AUTHENTICATION_TOKEN, testToken);
    ...
    it('should remove token from local storage', () => {
        ...
        removeAuthenticationToken();
        expect(localStorage.removeItem).toHaveBeenLastCalledWith(AUTHENTICATION_TOKEN);
