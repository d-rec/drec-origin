...
export const isTransferEvent = (
  e: ICertificateEvent,
): e is CertificateTransferredEvent =>
  e.type === CertificateEventType.Transferred;

export const isIssueEvent = (
  e: ICertificateEvent,
): e is CertificateIssuedEvent => e.type === CertificateEventType.Issued;

export const isIssuePersistedEvent = (
  e: ICertificateEvent,
): e is CertificateIssuancePersistedEvent =>
  e.type === CertificateEventType.IssuancePersisted;

export const isClaimEvent = (
  e: ICertificateEvent,
): e is CertificateClaimedEvent => e.type === CertificateEventType.Claimed;
...
export class CertificateIssuedEvent<MetadataType = unknown>
  implements ICertificateEvent
{
  ...
  public get id() {
    if (this._id === -1) {
      throw new Error(
        'Certificate event has not been saved, and has not set id',
      );
    }
...
export class CertificateIssuancePersistedEvent implements ICertificateEvent {
  ...
  public static createNew(
    ...
    return new CertificateIssuancePersistedEvent(
      -1,
...
export class CertificateTransferPersistedEvent implements ICertificateEvent {
  ...
  public static createNew(
    ...
    return new CertificateTransferPersistedEvent(
      -1,
      internalCertificateId,
      payload,
    );
...
export class CertificateClaimPersistedEvent implements ICertificateEvent {
  ...
  public static createNew(
    ...
    return new CertificateClaimPersistedEvent(
      -1,
      internalCertificateId,
      payload,
    );
