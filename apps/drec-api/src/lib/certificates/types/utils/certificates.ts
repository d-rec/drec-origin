...
import { CertificateEventEntity } from '../../offchain-certificate/repositories/certificate-event/certificate-event.entity';
import { DeploymentPropertiesEntity } from '../../onchain-certificate/repositories/deploymentProperties/deployment-properties.entity';
import { CertificateSynchronizationAttemptEntity } from '../../offchain-certificate/repositories/certificate-event/certificate-synchronization-attempt.entity';
import { CertificateCommandEntity } from '../../offchain-certificate/repositories/certificate-command/certificate-command.entity';
import {
  CertificateReadModelEntity,
  CertificateTransaction,
} from '../../offchain-certificate/repositories/certificate-read-modal/certificate-read-model.entity';
