  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "check_certificate_issue_date_log_for_device_group" ADD "certificateTransactionUID" citext`,
    );
    await queryRunner.query(
      `ALTER TABLE "check_certificate_issue_date_log_for_device" ADD "certificateTransactionUID" citext`,
    );
  }
